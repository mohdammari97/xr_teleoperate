            ...
            while self.running:
                ...
                if self.input_mode == 'controller':
                    ...
                    with left_hand_array.get_lock():
                        left_a_button = left_hand_array[0] > 0.5        # A button press
                        left_trigger_value = left_hand_array[1]         # Trigger value (0.0-1.0)
                        left_b_button = left_hand_array[2] > 0.5        # B button press (reserved)
                        
                    with right_hand_array.get_lock():
                        right_a_button = right_hand_array[0] > 0.5      # A button press
                        right_trigger_value = right_hand_array[1]       # Trigger value (0.0-1.0)
